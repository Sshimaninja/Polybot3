...
export interface FlashSUSHIQUICKInterface extends utils.Interface {
  functions: {
...
export interface FlashSUSHIQUICK extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: FlashSUSHIQUICKInterface;
