...
export interface FlashQUICKSUSHIInterface extends utils.Interface {
  functions: {
...
export interface FlashQUICKSUSHI extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: FlashQUICKSUSHIInterface;
