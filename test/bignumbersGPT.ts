...
import { BigNumber as JSBI } from "bignumber.js";
...
async function main() {
    ...
    var aPrice0JSBI = new JSBI.BigInt(aReserve0Formatted).div(
        aReserve1Formatted,
    );
    var aPrice1JSBI = new JSBI.BigInt(aReserve1Formatted).div(
        aReserve0Formatted,
    );
    var aPrice0JSBIFormatted = aPrice0JSBI.toString();
    var aPrice1JSBIFormatted = aPrice1JSBI.toString();
    ...
    let aPriceMap = {
        ...
        aPrice0JSBI: aPrice0JSBI,
        aPrice1JSBI: aPrice1JSBI,
        aPrice0JSBIFormatted: aPrice0JSBIFormatted,
        aPrice1JSBIFormatted: aPrice1JSBIFormatted,
    };
    console.log({
        exchangeA: aPriceMap,
    });
