...
describe('Trade', () => {
    it('should verify the values of the trade object', async () => {
        ...
        expect(result.loanPool.factory.address).toBe('factoryB_id');
        expect(result.loanPool.router.address).toBe('routerB_id');
        expect(result.loanPool.pool.address).toBe('poolBID');
        ...
        expect(result.target.factory.address).toBe('factoryA_id');
        expect(result.target.router.address).toBe('routerA_id');
        expect(result.target.pool.address).toBe('poolAID');
