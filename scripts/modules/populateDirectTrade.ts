...
//                 tradeSize: A ? this.amounts0.tradeSize.lt(this.price1.reserves.reserveIn) ? this.amounts0.tradeSize : this.price1.reserves.reserveIn : this.amounts1.tradeSize.lt(this.price0.reserves.reserveIn) ? this.amounts1.tradeSize : this.price0.reserves.reserveIn,
...
//         trade.profit = trade.loanPool.amountOut.gt(trade.amountRepay) ?
//             trade.loanPool.amountOut.sub(trade.recipient.amountOut) :
//             BigNumber.from(0);
