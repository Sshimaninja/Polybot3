...
//import { abi as Interface } from "@uniswap/v3-core/artifacts/contracts/interfaces/pool/IUniswapV3PoolState.sol/IUniswapV3PoolState.json";
...
//import {
//    MappedCallResponse,
//    singleContractMultipleValue,
//} from "./mutlipleContractSingleData";
...
//);
//const POOL_STATE_INTERFACE = Interface as IUniswapV3PoolStateInterface;

//export async function getTickRangeResponses(
//    lowerBound: number,
//    upperBound: number,
//    pool: ExtendedPool,
...
//        parameters,
//    ).catch((err: any) =>
//        console.log("Mapped Call Responose error:" + err),
//    ) as Promise<MappedCallResponse<TickResponse>>;
//}
...
//) {
//    return getContract<IUniswapV3PoolState>(
//        poolAddress,
//        IUniswapV3PoolStateABI,
//        provider,
//    ) as IUniswapV3PoolState;
//}
...
//    const tickRangeResponse = await getTickRangeResponses(
//        tickRange.lowerTick,
//        tickRange.upperTick,
//        pool,
//        multicallContract,
...
//    let limitTick = isDirection0For1
//        ? tickRange.lowerTick
//        : tickRange.upperTick;
//    console.log(
//        `TC: ${pool.tickCurrent}, TL: ${lowerTick}, TU: ${upperTick}, TRL: ${tickRange.lowerTick} TRU: ${tickRange.upperTick}`,
//    );
...
//        return JSBI.greaterThan(nextPriceTarget, sMaxPriceTarget)
//            ? nextPriceTarget
//            : sMaxPriceTarget;
//    } else {
